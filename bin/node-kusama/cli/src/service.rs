...
use futures::prelude::*;
use jupiter_kusama_runtime::RuntimeApi;
...
sc_executor::native_executor_instance!(
    pub KusamaExecutor,
    jupiter_kusama_runtime::api::dispatch,
    jupiter_kusama_runtime::native_version,
    frame_benchmarking::benchmarking::HostFunctions,
);

type FullClient = sc_service::TFullClient<Block, RuntimeApi, KusamaExecutor>;
type FullBackend = sc_service::TFullBackend<Block>;
type FullSelectChain = sc_consensus::LongestChain<FullBackend, Block>;
type FullGrandpaBlockImport =
    sc_finality_grandpa::GrandpaBlockImport<FullBackend, Block, FullClient, FullSelectChain>;
type LightClient = sc_service::TLightClient<Block, RuntimeApi, KusamaExecutor>;
...
> {
    let (client, backend, keystore_container, task_manager) =
        sc_service::new_full_parts::<Block, RuntimeApi, KusamaExecutor>(&config)?;
...
> {
    let (client, backend, keystore_container, mut task_manager, on_demand) =
        sc_service::new_light_parts::<Block, RuntimeApi, KusamaExecutor>(&config)?;
...
mod tests {
    ...
    use codec::Encode;
    use jupiter_kusama_runtime::constants::{currency::CENTS, time::SLOT_DURATION};
    use jupiter_kusama_runtime::{Address, BalancesCall, Call, UncheckedExtrinsic};
    use primitives::{Block, DigestItem, Signature};
