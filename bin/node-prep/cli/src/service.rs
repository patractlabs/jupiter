...
pub fn create_extrinsic(
    ...
    function: impl Into<jupiter_runtime::Call>,
    nonce: Option<u32>,
) -> jupiter_runtime::UncheckedExtrinsic {
    ...
    let period = jupiter_runtime::BlockHashCount::get()
        .checked_next_power_of_two()
        .map(|c| c / 2)
        .unwrap_or(2) as u64;
    let tip = 0;
    let extra: jupiter_runtime::SignedExtra = (
        frame_system::CheckNonZeroSender::<jupiter_runtime::Runtime>::new(),
        frame_system::CheckSpecVersion::<jupiter_runtime::Runtime>::new(),
        frame_system::CheckTxVersion::<jupiter_runtime::Runtime>::new(),
        frame_system::CheckGenesis::<jupiter_runtime::Runtime>::new(),
        frame_system::CheckEra::<jupiter_runtime::Runtime>::from(generic::Era::mortal(
            period,
            best_block.saturated_into(),
        )),
        frame_system::CheckNonce::<jupiter_runtime::Runtime>::from(nonce),
        frame_system::CheckWeight::<jupiter_runtime::Runtime>::new(),
        pallet_transaction_payment::ChargeTransactionPayment::<jupiter_runtime::Runtime>::from(tip),
        // pallet_asset_tx_payment::ChargeAssetTxPayment::<jupiter_runtime::Runtime>::from(tip, None),
    );

    let raw_payload = jupiter_runtime::SignedPayload::from_raw(
        function.clone(),
        extra.clone(),
        (
            (),
            jupiter_runtime::VERSION.spec_version,
            jupiter_runtime::VERSION.transaction_version,
            genesis_hash,
            best_hash,
            (),
            (),
    ...
    jupiter_runtime::UncheckedExtrinsic::new_signed(
        function.clone(),
        sp_runtime::AccountId32::from(sender.public()).into(),
        jupiter_runtime::Signature::Sr25519(signature.clone()),
        extra.clone(),
    )
}
...
pub fn new_partial(
    ...
    sc_service::PartialComponents<
        ...
        (
            impl Fn(
                jupiter_rpc::DenyUnsafe,
                sc_rpc::SubscriptionTaskExecutor,
            ) -> Result<jupiter_rpc::IoHandler, sc_service::Error>,
            (
...
> {
    ...
    let (rpc_extensions_builder, rpc_setup) = {
        ...
        let rpc_extensions_builder = move |deny_unsafe, subscription_executor| {
            ...
            jupiter_rpc::create_full(deps).map_err(Into::into)
        };
